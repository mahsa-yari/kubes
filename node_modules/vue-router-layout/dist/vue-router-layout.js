...
(function (global, factory) {
    ...
    (global = global || self, factory(global.VueRouterLayout = {}, global.Vue));
            ...
            Object.keys(record.components).forEach(function (key) {
                ...
                if (isAsync) {
                    promises.push(component().then(function (loaded) {
                        var isEsModule = loaded.__esModule ||
    ...
    function createRouterLayout(resolve) {
        ...
        return Vue.extend({
            ...
            provide: function () {
                var _this = this;
                return {
                    $_routerLayout_notifyRouteUpdate: function (to) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
